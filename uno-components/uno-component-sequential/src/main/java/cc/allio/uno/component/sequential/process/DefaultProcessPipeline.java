...
public class DefaultProcessPipeline implements ProcessPipeline {
    ...
    static class HandlerWrapper implements ProcessHandlerChain {
        ...
        public ProcessHandlerChain getPre() {
            return pre;
        }

        public void setPre(ProcessHandlerChain pre) {
            this.pre = pre;
        }

        public ProcessHandlerChain getNext() {
            return next;
        }

        public void setNext(ProcessHandlerChain next) {
            this.next = next;
        }
