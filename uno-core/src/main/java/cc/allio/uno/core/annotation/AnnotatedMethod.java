...
public class AnnotatedMethod implements Annotated {
	 ...
	 * Constructor
	 */
	public AnnotatedMethod(String name, Method method, List<Annotation> annotations) {
		this.name = name;
		this.method = method;
	 ...
	 */
	@Override
	public <T> T getValue(Object object, Class<T> expectedClass) throws DocumentFactoryException {
		Object value;
		try {
