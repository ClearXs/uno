 ...
 */
@Slf4j
public class CoreBeanUtil extends BeanUtils implements ApplicationContextAware {

    private static ApplicationContext context;

    @Override
    public void setApplicationContext(ApplicationContext context) throws BeansException {
        CoreBeanUtil.context = context;
    }
    ...
    public static <T> T clone(@Nullable T source) {
        ...
        return (T) CoreBeanUtil.copy(source, source.getClass());
    }
    ...
    public static <T> List<T> copy(@Nullable Collection<?> sourceList, Class<T> targetClazz) {
        ...
        for (Object source : sourceList) {
            ...
            T bean = CoreBeanUtil.copy(source, sourceClazz, targetClazz);
            outList.add(bean);
        }
        return outList;
    }
    ...
    public static <T> T copyWithConvert(@Nullable Object source, Class<T> targetClazz) {
        ...
        return CoreBeanUtil.copyWithConvert(source, source.getClass(), targetClazz);
    }
    ...
    public static <T> List<T> copyWithConvert(@Nullable Collection<?> sourceList, Class<T> targetClazz) {
        ...
        for (Object source : sourceList) {
            ...
            T bean = CoreBeanUtil.copyWithConvert(source, sourceClazz, targetClazz);
            outList.add(bean);
        }
        return outList;
    }
    ...
    public static <T> T copyProperties(@Nullable Object source, Class<T> targetClazz) throws BeansException {
        ...
        T to = newInstance(targetClazz);
        CoreBeanUtil.copyProperties(source, to);
        return to;
    }
    ...
    public static <T> List<T> copyProperties(@Nullable Collection<?> sourceList, Class<T> targetClazz) throws BeansException {
        ...
        for (Object source : sourceList) {
            ...
            T bean = CoreBeanUtil.copyProperties(source, targetClazz);
            outList.add(bean);
        }
        return outList;
    }
    ...
    public static Object generator(@Nullable Object superBean, BeanProperty... props) {
        ...
        CoreBeanUtil.copy(superBean, genBean);
        return genBean;
    }
