package cc.allio.uno.data.orm.executor.mangodb;
 ...
 * @since 1.1.4
 */
public class MangoDBSQLCommandExecutor implements SQLCommandExecutor {
    @Override
    ...
    public ExecutorKey getKey() {
        return SQLCommandExecutor.MONGODB_SQL_COMMAND_KEY;
    }
