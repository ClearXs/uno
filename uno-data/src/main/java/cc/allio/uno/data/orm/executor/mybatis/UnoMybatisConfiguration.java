 ...
 * @since 1.1.4
 */
public class UnoMybatisConfiguration extends Configuration {

    private final Configuration configuration;

    public UnoMybatisConfiguration(Configuration configuration) {
    ...
    public ResultSetHandler newResultSetHandler(Executor executor, MappedStatement mappedStatement, RowBounds rowBounds, ParameterHandler parameterHandler, ResultHandler resultHandler, BoundSql boundSql) {
        ResultSetHandler resultSetHandler = new UnoStatementSetHandler(executor, mappedStatement, parameterHandler, resultHandler, boundSql, rowBounds);
