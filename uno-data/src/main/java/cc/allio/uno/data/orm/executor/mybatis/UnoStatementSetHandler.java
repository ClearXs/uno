 ...
 * @since 1.1.4
 */
public class UnoStatementSetHandler extends DefaultResultSetHandler implements ResultSetHandler {

    public UnoStatementSetHandler(Executor executor, MappedStatement mappedStatement, ParameterHandler parameterHandler, ResultHandler<?> resultHandler, BoundSql boundSql, RowBounds rowBounds) {
    ...
    public void handleRowValues(ResultSetWrapper rsw, ResultMap resultMap, ResultHandler<?> resultHandler, RowBounds rowBounds, ResultMapping parentMapping) throws SQLException {
        ...
        while (shouldProcessMoreRows(resultContext, rowBounds) && !resultSet.isClosed() && resultSet.next()) {
            ...
            for (int i = 0; i < columnNames.size(); i++) {
                ...
                resultRowBuilder.column(SQLName.of(columnName, SQLName.HUMP_FEATURE));
