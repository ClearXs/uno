 ...
 * @since 1.1.4
 */
public class LTEExpression extends ColumnExpression implements ConditionExpression {

    public LTEExpression(RuntimeColumn column, ExpressionContext context) {
    ...
    protected Function<ValuePlaceholder, List<Tuple2<String, ExpressionValue>>> getValuePlaceholder() {
        return parameter -> {
            ...
            valuePlaceholders.add(
                    Tuples.of(
                            context.getTokenizer().createTokenString(column + StringPool.UNDERSCORE + Statement.LTE + StringPool.UNDERSCORE + index),
