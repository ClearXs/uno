...
import cc.allio.uno.data.sql.ColumnStatement;
import cc.allio.uno.data.sql.MethodReferenceColumn;
...
public interface Select<T extends Select<T>> extends ColumnStatement<T> {
    ...
    default T min(String fieldName, String alias) {
        return function(Func.MIN_FUNCTION, fieldName, alias, null);
    }
    ...
    default T max(String fieldName, String alias) {
        return function(Func.MAX_FUNCTION, fieldName, alias, null);
    }
    ...
    default T avg(String fieldName, String alias) {
        return function(Func.AVG_FUNCTION, fieldName, alias, null);
    }
    ...
    default T count(String fieldName, String alias) {
        return function(Func.COUNT_FUNCTION, fieldName, alias, null);
    }
     ...
     * @see Func
     */
    T function(String syntax, String fieldName, String alias, Distinct distinct);
