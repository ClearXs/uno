package cc.allio.uno.data.sql.word;
...
public class KeyWords {
    ...
    // Function
    public static final KeyWord COUNT = new KeyWord(Func.COUNT_FUNCTION);
    public static final KeyWord MIN = new KeyWord(Func.MIN_FUNCTION);
    public static final KeyWord MAX = new KeyWord(Func.MAX_FUNCTION);
    public static final KeyWord AVG = new KeyWord(Func.AVG_FUNCTION);
    public static final KeyWord SUM = new KeyWord(Func.SUM_FUNCTION);
