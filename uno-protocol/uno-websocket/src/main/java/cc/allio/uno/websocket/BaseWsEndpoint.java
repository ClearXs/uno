 ...
 */
@Slf4j
public abstract class BaseWsEndpoint<R> implements WsEndpoint {
     ...
     *     <li>加入{@link EndpointManager#registry(String, WsEndpoint)}</li>
     * </ul>
     */
    @OnOpen
    ...
    public boolean equals(Object obj) {
        // 会话Id作为唯一标识
        return obj instanceof BaseWsEndpoint &&
                this.session.getId().equals(((BaseWsEndpoint) obj).getSession().getId());
    }
    ...
    /**
     * 子类实现，把数据源转换为String类型，调用{@link FluxSink#next(Object)}方法对数据进行收集，根据{@link WsProperties#getCollectTime()}的结构异步发送</br>
