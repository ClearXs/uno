...
/**
 * 混合注解，构建MybatisPlus运行环境。代替{@link MapperScan}。
 * <p>
 * 对应的注解配置:
 *     <ul>
 *         <li>{@link MybatisPlusProperties}</li>
 *     </ul>
 * </p>
...
@Env({MybatisPlusEnvironment.class, DataSourceEnvironment.class, TransactionEnvironment.class})
public @interface MybatisPlusEnv {
